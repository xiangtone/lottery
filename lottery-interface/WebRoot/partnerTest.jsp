...
<body>
	...
	<input id="partnerOrderNumber" name="partnerOrderNumber" value=""
		size="40">
	<br> userPhoneNumber:
	<input id="userPhoneNumber" name="userPhoneNumber" value="<%=(request.getParameter("userPhoneNumber")!=null&&request.getParameter("userPhoneNumber").length()>0?request.getParameter("userPhoneNumber"):"13530274162")%>"
