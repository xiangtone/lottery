...
public class DecryptWebQueryCallbackTest {
	...
	public void decrypt() throws Exception {
		LOG.debug(this);
		QueryModifyBetAccountInfoUrlResultReq result = TestClientTransService.getInstance()
	...
	public static void main(String args[]) throws RsaDecryptException {
		DecryptWebQueryCallbackTest decryptWebQueryCallback = new DecryptWebQueryCallbackTest();
