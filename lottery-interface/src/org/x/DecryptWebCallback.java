...
public class DecryptWebCallback {
  ...
  public void decrypt() throws RsaDecryptException {
    ...
    PointExchangeLotteryResultReq result = ClientTransService.getInstance().decryptPointExchangeLotteryResultReq(
        getChannelId(), getTransSerialNumber(), getTransData());
    LOG.debug(result);
  }
  ...
  public static void main(String args[]) throws RsaDecryptException {
    ...
    decryptWebCallback.setChannelId("C12001");
    ...
    PointExchangeLotteryResultReq result = ClientTransService.getInstance()
        .decryptPointExchangeLotteryResultReq(decryptWebCallback.getChannelId(),
            decryptWebCallback.getTransSerialNumber(), decryptWebCallback.getTransData());
    LOG.debug(result);
  }
}
