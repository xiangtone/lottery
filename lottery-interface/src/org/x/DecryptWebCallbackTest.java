...
public class DecryptWebCallbackTest {
	...
	public void decrypt() throws Exception {
		LOG.debug(this);
		PointExchangeLotteryResultReq result = TestClientTransService.getInstance()
	...
	public static void main(String args[]) throws RsaDecryptException {
		DecryptWebCallbackTest decryptWebCallback = new DecryptWebCallbackTest();
		...
		PointExchangeLotteryResultReq result = TestClientTransService.getInstance().decryptPointExchangeLotteryResultReq(
