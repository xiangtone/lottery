...
public class ClientTransTestH5Service implements ClientTransServiceInterface {

	private static ClientTransTestH5Service clientTransService = new ClientTransTestH5Service();
	private static TestH5ClientUtil clientUtil = TestH5ClientUtil.getInstance();

	/*    */
	/*    */ public static ClientTransTestH5Service getInstance()
	/*    */ {
