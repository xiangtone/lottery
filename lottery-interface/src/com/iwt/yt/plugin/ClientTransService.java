...
/*    */
/*    */ public class ClientTransService implements ClientTransServiceInterface
/*    */ {
	private static ClientTransService clientTransService = new ClientTransService();
	private static ClientUtil clientUtil = ClientUtil.getInstance();
 ...
 * com.iwt.vasoss.bsf.agent.lottomagic.channel.comm.plugin.ClientTransService
