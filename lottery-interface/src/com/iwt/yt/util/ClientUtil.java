...
/*    */
/*    */ public class ClientUtil implements ClientUtilInterface
/*    */ {
	...
	/*    */ private void initPrivateKeyFile() {
		/*    */ try {
			/* 78 */ String privateKeyPath = URLDecoder.decode(
					ClientUtil.class.getClassLoader().getResource(LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES).getPath(), "UTF-8");
			/*    */
