...
public class TestH5ClientUtil implements ClientUtilInterface {

	private static final String LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES = "lottomagic-channel-comm-plugin-test-h5.properties";

	private static TestH5ClientUtil clientUtil = new TestH5ClientUtil();

	/*    */ public TestH5ClientUtil()
	/*    */ {
	...
	/*    */ public static TestH5ClientUtil getInstance() {
	...
	/*    */
	/*    */ public String encrypt(String channelId, String transData)/*    */ throws RsaEncryptException
	/*    */ {
	...
	/*    */
	/*    */ public String decrypt(String channelId, String transData)/*    */ throws RsaDecryptException
	/*    */ {
	...
	/*    */ private void initPrivateKeyFile() {
		/*    */ try {
			/* 78 */ String privateKeyPath = URLDecoder.decode(
					TestH5ClientUtil.class.getClassLoader().getResource(LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES).getPath(),
					"UTF-8");
			/*    */
			/* 81 */ String dirPath = privateKeyPath.substring(0,
					privateKeyPath.length() - LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES.length());
			/*    */
			...
			/* 89 */ this.paramMap.put("query-modify-bet-account-info-url",
					priKeyProps.getProperty("query-modify-bet-account-info-url"));
