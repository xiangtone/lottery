...
/*    */
/*    */ public class ClientH5Util implements ClientUtilInterface
/*    */ {
	/* 22 */ private static ClientH5Util clientUtil = new ClientH5Util();
	/*    */ private Map<String, String> paramMap;
	/*    */ private Map<String, RSAPrivateKey> privateKeyMap;
	/*    */ private static final String LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES = "lottomagic-channel-comm-plugin-h5.properties";
	...
	/*    */
	/*    */ public static ClientH5Util getInstance() {
	...
	/*    */ private void initPrivateKeyFile() {
		/*    */ try {
			/* 78 */ String privateKeyPath = URLDecoder.decode(
					ClientH5Util.class.getClassLoader().getResource(LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES).getPath(),
					"UTF-8");
			/*    */
