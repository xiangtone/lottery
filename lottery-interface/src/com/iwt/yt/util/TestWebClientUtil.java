...
public class TestWebClientUtil implements ClientUtilInterface {

	private static final String LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES = "lottomagic-channel-comm-plugin-test.properties";

	private static TestWebClientUtil clientUtil = new TestWebClientUtil();

	/*    */ public TestWebClientUtil()
	/*    */ {
	...
	/*    */ public static TestWebClientUtil getInstance() {
	...
	/*    */ private void initPrivateKeyFile() {
		/*    */ try {
			/* 78 */ String privateKeyPath = URLDecoder.decode(
					TestWebClientUtil.class.getClassLoader().getResource(LOTTOMAGIC_CHANNEL_COMM_PLUGIN_PROPERTIES).getPath(),
					"UTF-8");
			/*    */
