...
/*    */ 
/*    */ public class TestClientTransService
/*    */ {
/* 18 */   private static TestClientTransService clientTransService = new TestClientTransService();
/*    */ 
/*    */   public static TestClientTransService getInstance()
/*    */   {
...
/*    */   {
/* 29 */     return TestClientUtil.getInstance().getChannelId();
/*    */   }
/*    */ 
/*    */   public String getPointExchangeLotteryUrl()
/*    */   {
/* 34 */     return TestClientUtil.getInstance().getPointExchangeLotteryUrl();
/*    */   }
/*    */ 
/*    */   public String getQueryModifyBetAccountInfoUrl()
/*    */   {
/* 39 */     return TestClientUtil.getInstance().getQueryModifyBetAccountInfoUrl();
/*    */   }
/*    */ 
...
/* 49 */     return TestClientUtil.getInstance().encrypt(channelId, transEncryptData);
/*    */   }
/*    */ 
...
/* 59 */     String transDecryptData = TestClientUtil.getInstance().decrypt(channelId, transData);
...
/* 76 */     return TestClientUtil.getInstance().encrypt(channelId, transEncryptData);
/*    */   }
/*    */ 
...
/* 86 */     String transDecryptData = TestClientUtil.getInstance().decrypt(channelId, transData);
